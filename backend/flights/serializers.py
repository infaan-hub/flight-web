...
class LiveFlightSerializer(serializers.Serializer):
    ...
    sensor_count = serializers.IntegerField(allow_null=True, required=False, default=None)
    position_source = serializers.IntegerField(allow_null=True, required=False, default=None)
    position_jump = serializers.BooleanField(required=False, default=False)
